...
const UsersTrashed = () => {
    ...
    async function getCourses() {
        ...
        const rsp = await axios.post(CONST.API_SERVER + '/admin/users/trashed', formData, {
    ...
    async function deleteUser(uid) {
        ...
        const rsp = await axios.post(CONST.API_SERVER + '/admin/users/delete-parmanantly', formData, {
            'Content-Type': 'text/plain',
        });
        setIsLoaded(true)
        try {
    ...
    async function recoverUser(uid) {
        ...
        formData.append('uid', uid);
        const rsp = await axios.post(CONST.API_SERVER + '/admin/users/recover', formData, {
            'Content-Type': 'text/plain',
        });
        setIsLoaded(true)
        try {
                    ...
                    <div class="bodywrapper__inner">
                        <div class="row align-items-center mb-30 justify-content-between">
                            <div class="col-lg-6 col-sm-6">
                                <h6 class="page-title"> Blocked Users </h6>
                            </div>
                            <div class="col-lg-6 col-sm-6">
