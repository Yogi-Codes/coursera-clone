...
const ExamQueAdd = () => {
  ...
  const deleteCourse = async (id) => {
    ...
    const rsp = await axios.post(
      CONST.API_SERVER + "/admin/course/delete",
      formData,
      {
        "Content-Type": "text/plain",
      }
          ...
          <div class="bodywrapper__inner">
            <div class="row align-items-center mb-30 justify-content-between">
              <div class="col-lg-6 col-sm-6">
                <h6 class="page-title"> Exam Info </h6>
              </div>
              {/* <div class="col-lg-6 col-sm-6">
            ...
            <div className="row col-md-12">
              <div
                className="col-md-3 card p-2"
                // onClick={() => {
                //   window.location.href =
                //     "/course/edit/" + getPara("content-add");
                // }}
              >
                {" "}
                Edit Exam{" "}
              ...
              <div
                ...
                // onClick={() => {
                //   window.location.href =
                //     "/courses/weeks/" + getPara("content-add");
                // }}
              >
                {" "}
                Weeks/Chapters{" "}
              ...
              <div
                ...
                onClick={() => {
                  window.location.href =
                    "/exams/manage-questions/" + getPara("question-add");
                }}
              >
                Manage Exams
              </div>
              <div
                ...
                // onClick={() => {
                //   window.location.href =
                //     "/courses/enrolled/" + getPara("content-add");
                // }}
              >
                {" "}
                Enrolled Students{" "}
