...
const ManageContents = () => {
  ...
  async function getCourses() {
    ...
    formData.append("id", getPara("manage-contents"));
    const rsp = await axios.post(
      CONST.API_SERVER + "/admin/course/get-single",
      formData,
      {
  ...
  async function getWeeks() {
    ...
    formData.append("id", getPara("manage-contents"));
    const rsp = await axios.post(
      CONST.API_SERVER + "/admin/course/contents",
      formData,
      {
        "Content-Type": "text/plain",
      }
  ...
  const deleteChapter = async (id) => {
    ...
    const rsp = await axios.post(
      CONST.API_SERVER + "/admin/course/contents/delete",
      formData,
      {
        "Content-Type": "text/plain",
      }
                ...
                <div class="row align-items-center mb-30 justify-content-between">
                  ...
                  <div class="col-lg-6 col-sm-6">
                    <button
                      ...
                      onClick={() => {
                        window.location.href =
                          "/courses/content-add/" + getPara("manage-contents");
                      }}
                    ...
                    <button
                      ...
                      onClick={() => {
                        window.location.href =
                          "/courses/add-content/" + getPara("manage-contents");
                      }}
                    >
                      {" "}
                      Add Content{" "}
                              ...
                              {weeks.map((course, i) => (
                                <tr>
                                  ...
                                  <td>
                                    <a
                                      href={
                                        "/courses/content-edit/" + course.id
                                      }
                                    >
                                      {" "}
