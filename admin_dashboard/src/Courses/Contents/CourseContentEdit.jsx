...
const CourseContentEdit = () => {
  ...
  async function getCourses() {
    ...
    formData.append("id", getPara("content-edit"));
  ...
  async function addContent() {
    ...
    const rsp = await axios.post(
      CONST.API_SERVER + "/admin/course/add-content",
      formData,
      {
        "Content-Type": "text/plain",
      }
    ...
    try {
      if (rsp.data.message.length > 0 && rsp.data.message === "Success") {
        window.location.href =
          "/courses/manage-contents/" + getPara("add-content");
      } else {
        setIsLoading(false);
      }
    } catch (error) {}
                ...
                <div class="row align-items-center mb-30 justify-content-between">
                  ...
                  <div class="col-lg-6 col-sm-6">
                    <button
                      ...
                      onClick={() => {
                        window.location.href =
                          "/courses/content-add/" + getPara("content-edit");
                      }}
                      ...
                      <div class="card-body p-10">
                        <div className="row">
                          ...
                          <div className="col-md-6 row">
                            <div className="col-md-12">
                              <p>Estimated reading time (in mins ) </p>
                            </div>
                            <div className="col-md-6">
                              <input
                                type="number"
