...
const StudentsAll = () => {
    ...
    async function deleteUser(uid) {
        ...
        const rsp = await axios.post(CONST.API_SERVER + '/admin/student/delete', formData, {
            'Content-Type': 'text/plain',
        });
        setIsLoaded(true)
        try {
                    ...
                    <div class="bodywrapper__inner">
                        <div class="row align-items-center mb-30 justify-content-between">
                            <div class="col-lg-6 col-sm-6">
                                <h6 class="page-title"> All Students </h6>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <a href={"/stduents/new"} className='btn btn--primary float-right' > Add New Student </a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
