...
const StudentAdd = () => {
    ...
    async function submitForm() {
        ...
        const rsp = await axios.post(CONST.API_SERVER + '/admin/student/add', formData, {
                                        ...
                                        <div class="card-body p-10">
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <p> New user will be able to access client panel </p> <hr />
                                                </div>
                                                ...
                                                <div className="col-md-12">
                                                    <p>Designation </p>
                                                    <input type="text" className='form-control' required onChange={(e) => { setRank(e.target.value); }} />
                                                </div>
