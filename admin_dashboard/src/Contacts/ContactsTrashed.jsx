...
const ContactsTrashed = () => {
    ...
    async function getCourses() {
        ...
        const rsp = await axios.post(CONST.API_SERVER + '/admin/contacts/get/trashed', formData, {
    ...
    return (
        <>
        <Helmet>
            <title>Trashed contacts - { CONST.APPNAME }</title>
        </Helmet>
                    ...
                    <div class="bodywrapper__inner">
                        <div class="row align-items-center mb-30 justify-content-between">
                            <div class="col-lg-6 col-sm-6">
                                <h6 class="page-title"> All Trashed Contacts </h6>
                            </div>
...
export default ContactsTrashed